...
public class Constants {
    ...
    public static final String MSG_ENTER_COLOR = "\nPlease select 4 colors from the list above, separate by a space";
    public static final String MSG_RESULT_CHECK = "Here is the result:";
    public static final String MSG_COLOR_NO_MATCH = "The colors you entered doesn't match any.";
    public static final String MSG_WIN = "\nYou won!";
    public static final String MSG_NOT_WIN = "Your color doesn't match, please try again.";
