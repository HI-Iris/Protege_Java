class Constants {
    ...
    static final String MSG_WIN = "You won!";
    static final String MSG_WELCOME = "Welcome to the Master Mind Game\nThe Master Mind has selected four colors from Red, Blue, Green, Orange, Purple and Yellow!";
    static final String MSG_ENTER_COLOR = "Please select 4 colors from the list above, separate by a space";
    static final String MSG_COLOR_CHECK = "Here is the result:";
    static final String MSG_COLOR_NO_MATCH = "The colors you entered doesn't match any.";
